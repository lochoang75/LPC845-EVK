...
src/%.o: ../src/%.c
	...
	arm-none-eabi-gcc -DDEBUG -D__USE_CMSIS -D__CODE_RED -DCORE_M0PLUS -D__MTB_DISABLE -D__MTB_BUFFER_SIZE=256 -D__LPC84X__ -D__REDLIB__ -I"C:\Users\PC-001\Documents\MCUXpressoIDE_11.1.1_3241\workspace\UART0_Terminal\inc" -I"C:\Users\PC-001\Documents\MCUXpressoIDE_11.1.1_3241\workspace\peripherals_lib\inc" -I"C:\Users\PC-001\Documents\MCUXpressoIDE_11.1.1_3241\workspace\utilities_lib\inc" -I"C:\Users\PC-001\Documents\MCUXpressoIDE_11.1.1_3241\workspace\common\inc" -O0 -fno-common -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fmerge-constants -fmacro-prefix-map="../$(@D)/"=. -mcpu=cortex-m0 -mthumb -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
